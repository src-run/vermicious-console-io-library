...
final class ActionFactory
{
    ...
    private static function resolveQualifiedActionTypeClass(string $type = null): string
    {
        ...
        throw new InvalidArgumentException('Unable to find action of type class (none of %s are valid action types).', implode(', ', array_map(function (string $type): string { return sprintf('"%s"', $type); }, $fqns)));
    }
